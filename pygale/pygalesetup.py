#
# $Id: pygalesetup.py,v 1.2 2003/01/03 01:13:09 tlau Exp $
#
import Tkinter
...
class WizardDialog(Tkinter.Frame):
	def __init__(self, master, frame_list):
		...
		self.frame_area.grid(row = 0, column = 0, sticky = 'wens', padx = 10)
		...
		self.separator.grid(row = 1, column = 0, padx = 10)
		self.button_area = Tkinter.Frame(self, width = 280, height = 50)
		self.button_area.grid_propagate(0)
		self.button_area.grid(row = 2, column = 0, sticky = 'we', padx = 10)
		...
		self.prev_button = Tkinter.Button(self.button_area, 
						  command = self.prev,
						  text = 'Prev', width = 10)
		self.prev_button.grid(row = 0, column = 0, sticky = 'e')
...
class FindSignature(Tkinter.Frame):
	...
	def display(self):
		...
		self.label.grid(row = 0, column = 0, sticky = 'we', 
				columnspan = 2)
		self.entry.grid(row = 1, column = 0, sticky = 'nwe')
		self.browse_button.grid(row = 1, column = 1, sticky = 'nw', padx = 5)
